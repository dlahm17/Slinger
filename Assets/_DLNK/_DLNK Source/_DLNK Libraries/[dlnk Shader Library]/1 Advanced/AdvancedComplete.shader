...
////// Specular:
                ...
                float node_5831 = lerp(saturate(((1.0 - _OcclusionStrenght)+(_OcclusionMap_var.r*_OcclusionStrenght))),1.0,node_8121);
                ...
                float4 _Cavity_var = tex2D(_Cavity,TRANSFORM_TEX(node_7427, _Cavity));
...
/////// Diffuse:
                ...
                float3 backLight = max(float3(0.0,0.0,0.0), -NdotLWrap + w ) * float3(node_5158,node_5158,node_5158);
